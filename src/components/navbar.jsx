        ...
        <div className="container w-full m-auto ">
            <nav className="flex flex-row justify-around px-0 py-[20px] w-full">
                ...
                <div className="flex flex-row gap-24 items-center text-[17px]">
                    ...
                    <a href="#" className="text-[#fff]">Atamalar</a>
                </div>

                <div className="rounded-[12px] h-[45px] flex self-center items-center px-9 cursor-pointer"
                    style={{ border: "1px solid #C1C1C1" }}>
                    <a href="#" className="text-[16px] text-[#FFFFFF] font-normal">Qollab quvvatlash</a>
                </div>
            </nav>
        </div>
    )
